...
var ICalEvent = function(_data) {
	...
	this.repeating = function(repeating) {
		...
		if(repeating.excludeDates) {
			if(!Array.isArray(repeating.excludeDates)){
				throw '`repeating.excludeDates` must be an Array of Dates!';
			}
			
			data.repeating.excludeDates = repeating.excludeDates;
		}
	...
	this.generate = function(calendar) {
		...
		if(data.repeating) {
			...
			if(data.repeating.excludeDates) {
				var formatedDates = new Array();
				data.repeating.excludeDates.forEach(function(derp) {
